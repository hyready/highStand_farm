        ...
        return (
            <div className=''>
                <table className='projectData' onChange={this.change.bind(this)}>
                    ...
                    <tr>
                        <td><span>最大过水流量：</span><input value={data.zdgsll} name='zdgsll'/></td>
                        <td><span>名称：</span><input value={data.mc} name='mc'/></td>
                        <td><span>编号：</span><input value={data.bh} name='bh'/></td>

                    </tr>
                    <tr>
                        <td><span>路面材质：</span><input value={data.lmcz} name='lmcz'/></td>
                        <td><span>路面长度：</span><input value={data.dlcd} name='dlcd'/></td>
                        <td><span>建设性质：</span><input value={data.jsxz} name='jsxz'/></td>
                    </tr>
                    <tr>
                        <td><span>长度：</span><input value={data.cd} name='cd'/></td>
...
export default withRouter(过水路面);
