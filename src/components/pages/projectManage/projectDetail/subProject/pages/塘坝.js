            ...
            <div className=''>
                <table className='projectData' onChange={this.change.bind(this)}>
                    ...
                    <tr>
                        ...
                        <td><span>库容(立方米)：</span><input value={data.kr} name='kr'/></td>
                        <td><span>坝高(米)：</span><input value={data.bg} name='bg'/></td>
                    </tr>
                    <tr>
                    <td><span>占地面积(平方米)：</span><input value={data.zdmj} name = 'zdmj'/></td>
