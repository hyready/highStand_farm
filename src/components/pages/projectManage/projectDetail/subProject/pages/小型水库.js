            ...
            <div className=''>
                <table className='projectData'  onChange={this.change.bind(this)}>
                    ...
                    <tr>
                        ...
                        <td><span>库容：</span><input value={data.kr} name='kr'/></td>
                        <td><span>坝高：</span><input value={data.bg} name='bg'/></td>


                    </tr>
                    <tr>
                        <td><span>迎水坡度：</span><input value={data.yspd} name='yspd'/></td>
                        <td><span>背水坡度：</span><input value={data.bspd} name='bspd'/></td>
...
export default withRouter(小型水库);
