        ...
        return (
            <div className=''>
                <table className='projectData'  onChange={this.change.bind(this)}>
                    ...
                    <tr>
                        <td><span>类型：</span><input value={data.lx} name='lx'/></td>
                        <td><span>编号：</span><input value={data.bh} name='bh'/></td>
                        <td><span>容积：</span><input value={data.rj} name='rj'/></td>

                    </tr>
                    <tr>
                        <td><span>水窖深度：</span><input value={data.sjsd} name='sjsd'/></td>
                        <td><span>水窖直径：</span><input value={data.sjzj} name='sjzj'/></td>
                        <td><span>占地面积：</span><input value={data.bsm} name='bsm'/></td>
                    </tr>
                    <tr>
