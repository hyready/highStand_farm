        ...
        return (
            <div className=''>
                <table className='projectData'  onChange={this.change.bind(this)}>
                    ...
                    <tr>
                        <td><span>跌水陡坡编号：</span><input value={data.dsbh} name='dsbh'/></td>
                        <td><span>跌水陡坡名称：</span><input value={data.dsmc} name='dsmc'/></td>
                        <td><span>跌差：</span><input value={data.dc} name='dc'/></td>
...
export default withRouter(跌水陡坡);
