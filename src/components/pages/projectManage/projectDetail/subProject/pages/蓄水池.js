            ...
            <div className=''>
                <table className='projectData' onChange={this.change.bind(this)} >
                    ...
                    <tr>
                        ...
                        <td><span>池深：</span><input value={data.cs} name='cs'/></td>


                    </tr>
                    <tr>
                        <td><span>池体材质：</span><input value={data.ctcz} name='ctcz'/></td>
