            ...
            <div className=''>
                <table className='projectData' onChange={this.change.bind(this)}> <tbody>
                    ...
                    <tr>
                        ...
                        <td><span>株距：</span><input value={data.zj} name = 'zj'/></td>
                        <td><span>行距：</span><input value={data.hj} name = 'hj'/></td>
                    </tr>
                    <tr>
                        <td><span>行数：</span><input value={data.hs} name = 'hs'/></td>
                    ...
                    <tr>
                        ...
                        <td><span>胸径：</span><input value={data.xj} name = 'xj'/></td>
                    </tr>
                    <tr>
