            ...
            <div className=''>
                <table className='projectData' onChange={this.change.bind(this)}>
                    ...
                    <tr>
                        ...
                        <td><span>喷灌类型：</span><input value={data.pglx} name='pglx'/></td>
                        <td><span>管道管径：</span><input value={data.gdgj} name='gdgj'/></td>
                    </tr>
                    <tr>
                        <td><span>管道材质：</span><input value={data.gdcz} name='gdcz'/></td>
                        <td><span>管道设计流速：</span><input value={data.gdsjls} name='gdsjls'/></td>
                        <td><span>管壁厚度：</span><input value={data.gbhd} name='gbhd'/></td>
                    </tr>
                    <tr>
                        <td><span>喷头数量：</span><input value={data.ptsl} name='ptsl'/></td>
                        <td><span>喷头间距：</span><input value={data.ptjj} name='ptjj'/></td>
                        <td><span>喷头出水量：</span><input value={data.ptcsl} name='ptcsl'/></td>
                    </tr>
                    <tr>
                        <td><span>喷头类型：</span><input value={data.ptlx} name='ptlx'/></td>
...
export default withRouter(喷灌管道);
