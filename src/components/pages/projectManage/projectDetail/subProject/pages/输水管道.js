            ...
            <div className=''>
                <table className='projectData'  onChange={this.change.bind(this)} >
                 <tbody>
                        ...
                        <tr> <td><span>结束时间：</span><input type='date'  value={data.jssj} name = 'jssj'/></td>
                            <td><span>标识码：</span><input value={data.bsm} name = 'bsm'/></td>
                            <td><span>要素代码：</span><input value={data.ysdm} name = 'ysdm'/></td>

                        </tr>
                    
                        <tr> <td><span>管道长度(米)：</span><input value={data.gdcd} name = 'gdcd'/></td>
                        ...
                        <tr>
                            ...
                            <td><span>备注：</span><input value={data.bz} name = 'bz'/></td><td></td><td></td>
                        </tr>
...
export default withRouter(输水管道);
