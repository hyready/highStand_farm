        ...
        return (
            <div className=''>
                <table className='projectData' onChange={this.change.bind(this)} >
                    ...
                    <tr>
                        <td><span>农桥类型：</span><input value={data.nqlx} name='nqlx'/></td>
                        <td><span>农桥编号：</span><input value={data.nqbh} name='nqbh'/></td>
                        <td><span>农桥名称：</span><input value={data.nqmc} name='nqmc'/></td>
                    </tr>
                    <tr>
                        <td><span>农桥设计净宽(米)：</span><input value={data.nqsjjk} name='nqsjjk'/></td>
                        <td><span>农桥设计荷载(吨)：</span><input value={data.nqsjhz} name='nqsjhz'/></td>
                        <td><span>农桥校核荷载(吨)：</span><input value={data.nqjhhz} name='nqjhhz'/></td>
                    </tr>
                    <tr>
                        <td><span>农桥跨度(米)：</span><input value={data.nqkd} name='nqkd'/></td>
