        ...
        return (
            <div className=''>
                <table className='projectData'  onChange={this.change.bind(this)} >
                    ...
                    <tr>
                        <td><span>流量(吨)：</span><input value={data.ll} name='ll'/></td>
                        <td><span>量水设施名称：</span><input value={data.lsssmc} name='lsssmc'/></td>
                        <td><span>量水设施编号：</span><input value={data.lsssbh} name='lsssbh'/></td>
...
export default withRouter(量水设施);
