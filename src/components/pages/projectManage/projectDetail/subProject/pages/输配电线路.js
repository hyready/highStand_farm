        ...
        return (
            <div className=''>
                <table className='projectData' onChange={this.change.bind(this)}>
                    ...
                    <tr>
                        <td><span>长度(米)：</span><input value={data.cd} name='cd'/></td>
                        <td><span>电压等级(千伏)：</span><input value={data.dydj} name='dydj'/></td>
                        <td><span>线路编号：</span><input value={data.xlbh} name='xlbh'/></td>
...
export default withRouter(输配电线路);
